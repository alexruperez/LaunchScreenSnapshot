...
public class LaunchScreenSnapshot {
    ...
    fileprivate var dampingRatio: CGFloat = 0
    fileprivate var velocity: CGFloat = 0
    fileprivate var options: UIViewAnimationOptions = []
     ...
     */
    @discardableResult public static func protect(with view: UIView? = nil, duration: TimeInterval = 0, delay: TimeInterval = 0, dampingRatio: CGFloat = 1, velocity: CGFloat = 0, options: UIViewAnimationOptions = [], force: Bool = false) -> LaunchScreenSnapshot {
        let launchScreenSnapshot = LaunchScreenSnapshot.shared
        launchScreenSnapshot.protect(with: view, duration: duration, delay: delay, dampingRatio: dampingRatio, velocity: velocity, options: options, force: force)
     ...
     */
    @discardableResult public func protect(with view: UIView? = nil, duration: TimeInterval = 0, delay: TimeInterval = 0, dampingRatio: CGFloat = 1, velocity: CGFloat = 0, options: UIViewAnimationOptions = [], force: Bool = false) -> Bool {
        self.view = view
        if self.view == nil {
        ...
        self.delay = delay
        assert(dampingRatio > 0, "LaunchScreenSnapshot: dampingRatio must be greater than 0.")
